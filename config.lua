...
-- MarkerColor 														- Adjust these numbers based on any RGBa color scale to choose your marker and text color.
Config.MarkerColor      = { r = 50, g = 255, b = 50, a = 125 }		-- Alpha is only used for the marker, texts have no alpha

-- ShowText 														- 1 = show who is talking text    0 = do not show text
Config.ShowText 		= 1

-- Text Placement on screen   										- 0 = top center   1 = left
Config.TextPlacement 	= 1
